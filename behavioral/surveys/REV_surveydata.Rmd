...
survey_data$scons_pca_items <- survey_data[scons_cols]
...
# isolate raw items with relevant items reverse scored for later PCA analysis
survey_data$bis_pca_items <- survey_data[bis_cols]
...
# isolate raw items with relevant items reverse scored for later PCA analysis
survey_data$bis_bas_pca_items <- survey_data[bis_bas_cols]
...
# isolate raw items with relevant items reverse scored for later PCA analysis
survey_data$upps_pca_items <- survey_data[upps_cols]
