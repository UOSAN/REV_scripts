...
homeBase = readline(prompt = "Enter wd path for REV_scripts folder, e.g., ~/Desktop/REV : ")
...
all_pca_vars <- cbind(scons_pca_items,bis_pca_items,bis_bas_pca_items) #%>% na.omit(all_pca_vars)
...
# DOUBLE CHECK THESE
survey_data$RC_drive <- pca.orthogonal$scores[,1]
survey_data$RC_pos_affect <- pca.orthogonal$scores[,2]
survey_data$RC_neg_affect <- pca.orthogonal$scores[,3]
