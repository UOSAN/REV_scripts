...
# Calculate total score
survey_data$ftnd_total <- rowMeans(survey_data[ftnd_recode_cols]) # ftnd total score
...
# compile a list of the HRB variables (raw scale means)
hrb_vars <- c()

survey_data$bscs_a_z <- scale(survey_data$bscs_a, center = TRUE, scale = TRUE)
