...
# reliability
omega_bscs_a_tot <- omega(survey_data[bscs_key_list[[1]]])[[4]]
#omega_bscs_c_tot <- omega(survey_data[bscs_key_list[[2]]])[[4]]
#omega_bscs_h_tot <- omega(survey_data[bscs_key_list[[3]]])[[4]]
omega_bscs_ma_tot <- omega(survey_data[bscs_key_list[[4]]])[[4]]
omega_bscs_me_tot <- omega(survey_data[bscs_key_list[[5]]])[[4]]
omega_bscs_p_tot <- omega(survey_data[bscs_key_list[[6]]])[[4]]
...
# reliability
key_acq_sf_r <- ifelse(acq_sf_r_cols %in% reverse_cols, -1, 1)
omega_acq_sf_r_tot <- omega(survey_data[acq_sf_r_cols], key = key_acq_sf_r)[[4]]
...
# reliability
omega_audit_tot <- omega(survey_data[audit_cols])[[4]]
...
# reliability
omega_pacs_tot <- omega(survey_data[pacs_cols])[[4]]
...
# reliability
omega_mcq_sf_tot <- omega(survey_data[mcq_sf_cols])[[4]]
...
# reliability
# omega_ceq_s_p_tot <- omega(survey_data[ceq_s_p_cols])[[4]]
...
# reliability
omega_ftnd_tot <- omega(survey_data[ftnd_cols])[[4]]
...
# reliability
omega_qsu_tot <- omega(survey_data[qsu_cols])[[4]]
...
# reliability
key_debq <- ifelse(debq_cols %in% reverse_cols, -1, 1)
omega_debq_tot <- omega(survey_data[debq_cols], key = key_debq)[[4]]
...
# reliability
key_fci <- ifelse(fci_cols %in% reverse_cols, -1, 1)
omega_fci_tot <- omega(survey_data[fci_cols], key = key_fci)[[4]]
```
...
# reliability
key_bis_bas <- ifelse(bis_bas_cols %in% reverse_cols, -1, 1)
omega_bis_bas_tot <- omega(survey_data[bis_bas_cols], key = key_bis_bas)[[4]]
```
...
# reliability
key_upps <- ifelse(upps_cols %in% reverse_cols, -1, 1)
omega_upps_tot <- omega(survey_data[upps_cols], key = key_upps)[[4]]
```
...
```{r Summary of omega reliability}
