...
survey_data$bscs_a_z <- scale(survey_data$bscs_a, center = FALSE, scale = TRUE)

bscs_a_z_1 <- (survey_data$bscs_a[1] - mean(survey_data$bscs_a, na.rm = T))/sd(survey_data$bscs_a, na.rm = T)

survey_data$bscs_a_z[1]
```
