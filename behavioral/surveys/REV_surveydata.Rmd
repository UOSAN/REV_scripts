...
categories <- as.data.frame(read.table(paste0(catDir, "participantCategories.txt"))) #MM
...
gen_survey <- read_sav(paste0(dataDir, "REV_General_Survey.sav")) #MM
...
base_survey <- read_sav(paste0(dataDir, "REV_Baseline_Survey.sav")) #MM
...
screen_data <- as.data.frame(read.csv(paste0(dataDir, "rev_screening.csv"), stringsAsFactors = FALSE, skip = 1)) #MM
