...
homeBase = '~/Desktop' #this is the only thing you should need to change
...
bscs_data <- lapply(survey_data[bscs_cols], as.numeric)
...
acq_sf_r_data <- lapply(survey_data[acq_sf_r_cols], as.numeric)
