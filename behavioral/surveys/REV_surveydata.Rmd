...
# create separate data frame with only CRAVE vars
...
# create separate data frame with only CONSUMPTION vars
weighted_consumption_vars <- weighted_vars[,c("duh_a_avg_use_per_day_z_w", "audit_total_z_w", "duh_c_avg_use_per_day_z_w", "duh_h_avg_use_per_day_z_w", "duh_ma_avg_use_per_day_z_w", "duh_me_avg_use_per_day_z_w", "duh_p_avg_use_per_day_z_w", "ftnd_total_z_w", "debq_total_z_w")]

# Average all weighted z-scored CRAVING measures into a single HRB CRAVING summary variable 
survey_data$hrb_crave <- rowMeans(weighted_crave_vars, na.rm = TRUE)

# Average all weighted z-scored CONSUMPTION measures into a single HRB CONSUMPTION summary variable 
survey_data$hrb_consumption <- rowMeans(weighted_consumption_vars, na.rm = TRUE)
```
