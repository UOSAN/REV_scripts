function MSS(tdfile,resource_path,subject_code)
...
script_revision_date='09/16/14';
    ...
    %Revisions
        ...
        %9/16/14: code to get MSS to use the correct input device to recognize the trigger from the scanner
    
        
experiment_notes='This is the cueReact script for the REV study.';
...
%subject_code = num2str(subject_code);
...
%DrawFormattedText_new(w,'Experiment will begin shortly.','center','center', white, default_wrap, 0, 0);
DrawFormattedText(w,'The scan is about to begin.  Please remain completely still.','center','center', white, default_wrap);
Screen('Flip',w);
