function MSS_NBack(tdfile,resource_path,startToggle)
...
experiment_code='NBk';  % this should be a short (2-3 letter) code for the experiment
                        % it will be put as part of the data file name
script_revision_date='09/14/11';
...
experiment_notes='This is the script for the NBack task (NBk).';
