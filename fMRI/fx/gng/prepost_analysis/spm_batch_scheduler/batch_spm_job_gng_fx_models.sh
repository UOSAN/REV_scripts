...
SCRIPT=${STUDY}/REV_scripts/fMRI/fx/gng/prepost_analysis/scripts/matlabbatch_job_gng.m
...
# Set output dir
OUTPUTDIR=${STUDY}/REV_scripts/fMRI/fx/gng/prepost_analysis/scripts/output_logs
