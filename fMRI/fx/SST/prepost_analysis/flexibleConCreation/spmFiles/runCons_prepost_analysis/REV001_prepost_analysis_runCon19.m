...
matlabbatch{2}.cfg_basicio.var_ops.subsrefvar.subsreference{1}.subsindc = {19};
...
matlabbatch{3}.cfg_basicio.var_ops.subsrefvar.subsreference{1}.subsindc = {19};
...
matlabbatch{4}.spm.stats.con.consess{1}.tcon.name(1) = cfg_dep('Access part of MATLAB variable: val{19}', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','output'));
matlabbatch{4}.spm.stats.con.consess{1}.tcon.weights(1) = cfg_dep('Access part of MATLAB variable: val{19}', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','output'));
