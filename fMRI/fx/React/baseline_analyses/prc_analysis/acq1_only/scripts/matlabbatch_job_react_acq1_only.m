...
matlabbatch{8}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 'rp_REV001_1_react_1.txt';  % auto_motion output file acq-1
...
matlabbatch{9}.cfg_basicio.file_dir.file_ops.file_fplist.filter = 'sub-REV001_task-React_acq-1_onsets_.*.mat';
...
matlabbatch{10}.spm.stats.fmri_spec.sess.multi(1) = cfg_dep('File Selector (Batch Mode): Selected Files (sub-REV001_task-React_acq-1_onsets_.*.mat)', substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
matlabbatch{10}.spm.stats.fmri_spec.sess.regress = struct('name', {}, 'val', {});
matlabbatch{10}.spm.stats.fmri_spec.sess.multi_reg(1) = cfg_dep('File Selector (Batch Mode): Selected Files (rp_REV001_1_react_1.txt)', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','files'));
