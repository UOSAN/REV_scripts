...
images=(con_0006.nii) #corrGo_T1 corrGo_T2 corrStop_T1 corrStop_T2 #images to extract parameter estimates from (alt. example: images=`echo $(printf "beta_%04d.nii\n" {1..36}) $(printf "beta_%04d.nii\n" {43..78})`)
...
output_dir=/projects/sanlab/shared/REV/REV_scripts/fMRI/roi/parameterEstimates/con_06 #parameter estimate output directory
